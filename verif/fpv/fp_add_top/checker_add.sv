checker add_module_checker(clk, rst, op1, op2, start, rdy, result);
	...
	//assume property (op1 == 32'b01010010000000100100000000000111);
	//assume property (op2 == 32'b01000010000000100100000000000111);
	...
	//output -0   
	cover_neg_zero: cover property (result == 32'b10000000000000000000000000000000);	
